...
def main():
    ...
    parser.add_argument('-end',type=str,help="Fecha final de la serie")
...
def show_table(args):
    ...
    df = pdr.get_data_yahoo(args.symbol,start=datetime.datetime(int(fecha_dt1[0]),int(fecha_dt1[1]),int(fecha_dt1[2])),
                                end=datetime.datetime(int(fecha_dt2[0]),int(fecha_dt2[1]),int(fecha_dt2[2])))
